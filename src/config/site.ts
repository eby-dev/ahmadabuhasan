...
export const SITE = {
  ...
  /**
   * Google AdSense publisher ID (`ca-pub-…`). Empty string removes both the
   * ownership meta tag and the ad loader, so clearing this field takes AdSense
   * off the site — but see public/_headers, whose CSP stays widened until
   * someone narrows it by hand.
   *
